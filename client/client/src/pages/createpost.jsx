      ...
      <div className="flex flex-col p-5">
        ...
        <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-5 mb-5">
          <textarea
            ...
            className="w-full md:w-3/4 h-96 p-3 border border-gray-300 rounded resize-none"
            required
          />

          <div className="w-full md:w-1/2 bg-gray-100 p-5 rounded space-y-5">
            <div>
